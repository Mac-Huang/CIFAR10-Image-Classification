...
def main():
    ...
    net = Net()
    net.load_state_dict(torch.load('./Deep_Learning/ResMacNet/ResMacNet.pth'))
    net = net.to(device)
    ...
    with torch.no_grad():
        for data in testloader:
            ...
            all_outputs.extend(torch.nn.functional.softmax(outputs, dim=1).cpu().detach().numpy())
    ...
    df.to_excel('./Deep_Learning/Results/ResMacNet_Results/Test_Results.xlsx', index=False)
    ...
    plt.savefig('./Deep_Learning/Results/ResMacNet_Results/ROC.png')
    plt.show()
    ...
    plt.savefig('./Deep_Learning/Results/ResMacNet_Results/Accuracy.png')
    # plt.savefig('./Deep_Learning/Results/ResMacNet_Results/Accuracy_on_Training_Dataset.png')
    ...
    plt.savefig('./Deep_Learning/Results/ResMacNet_Results/Confusion_Matrix.png')
    # plt.savefig('./Deep_Learning/Results/ResMacNet_Results/Confusion_Matrix_on_Training_Dataset.png')
